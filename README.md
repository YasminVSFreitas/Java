O projeto tem como objetivo bem simples, de criar um sistema de entrada de preços que aplica uma taxa de juros em um 
determinado preço digitado pelo teclado. A taxa aplicada deve ser:
